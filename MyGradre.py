...
def Check_my_grade():
    ...
    browser.find_element(by = By.XPATH, value='//*[@id="ctl00_LastName"]').send_keys('Николаев')
    sleep(1)
    browser.find_element(by=By.XPATH, value='//*[@id="ctl00_FirstName"]').send_keys('Игорь')
    sleep(1)
    browser.find_element(by=By.XPATH, value='//*[@id="ctl00_MidName"]').send_keys('Игоревич')
    sleep(1)
    browser.find_element(by=By.XPATH, value='//*[@id="ctl00_Number"]').send_keys('723981')
    ...
    Grade = browser.find_element(by=By.XPATH, value='/html/body/form/table/tbody/tr[2]/td/table/tbody/tr/td[2]/div/table/tbody/tr[3]/td[5]').text
    sleep(2)
    browser.close()
    return Grade
